...
define('DB_USER',				'm168717admin');
define('DB_PASS',				'zzeerrooZerolone');
define('DB_HOST',				'mysql-m');
define('DB_PORT',				'3306');
define('DB_NAME',				'm168717_blog');
define('DB_LANG',				'UTF8');
define('DB_TABLE_PRE',	'');	
//-----------------------------------------------------------
...
//网站物理路径 site dir
define('SITE_DIR',				'/home/groups/m/mo/monolith-cms/htdocs/blog/');
define('SITE_URL',				'http://www.zerolone.com/blog/');
